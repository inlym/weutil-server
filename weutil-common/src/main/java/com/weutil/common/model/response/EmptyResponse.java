 ...
 * <p>控制器返回本对象后，由 StandardResponseAdvice 转换为 StandardResponse 输出，
 * 前端收到的是统一的 errorCode + errorMessage 结构。
 *
 * <h2>不可变说明
 * <p>类不生成 setter，保证 SUCCESS 共享常量无法被调用方修改。
 *
 * <h2>使用场景
...
public class EmptyResponse {
     ...
     * <p>使用默认的成功消息键 "response.success"，由 StandardResponseAdvice 转换为实际文案。
     *
