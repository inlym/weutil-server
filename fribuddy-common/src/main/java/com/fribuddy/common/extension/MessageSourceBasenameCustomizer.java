package com.fribuddy.common.extension;
 ...
 *
 * <h2>命名约定
 * <p>basename 形如 i18n/<模块标识>，模块标识取所属业务模块或子模块的包路径，去掉 com.fribuddy. 前缀后将剩余段的点号替换为连字符。
 * <p>例如 com.fribuddy.common → i18n/common，com.fribuddy.modules.device → i18n/modules-device。
 *
